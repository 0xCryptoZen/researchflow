...
### P0-2 数据同步能力
- [ ] **P0-2.1** 实现增量同步 API (10min)
- [ ] **P0-2.2** 改造 Repository 层支持云端模式 (15min)
- [ ] **P0-2.3** 添加离线缓存支持 (10min)

### P0-3 存储层统一
- [ ] **P0-3.1** 补齐剩余模块仓储化 (15min)
- [ ] **P0-3.2** 完善 storage service 事件机制 (10min)
...
- [ ] **P1-2.2** 实现 N 天规则化提醒 (10min)

### P1-3 任务增强
- [ ] **P1-3.1** 优化任务编辑 UI (10min)
- [ ] **P1-3.2** 任务关联论文/会议完整 (10min)
...
### P2-1 提醒系统
- [ ] **P2-1.1** 接入邮件通知 (SMTP/SendGrid) (20min)
- [ ] **P2-1.2** 接入飞书/钉钉 webhook (15min)
- [ ] **P2-1.3** 接入 Telegram Bot 通知 (15min)

### P2-2 LaTeX 模板
- [ ] **P2-2.1** 实现模板预览功能 (10min)
- [ ] **P2-2.2** 实现模板克隆/下载 (10min)
