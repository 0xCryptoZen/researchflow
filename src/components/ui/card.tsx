...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-5 rounded-xl border border-[rgba(255,255,255,0.08)] py-5 transition-all duration-200",
        "hover:border-[rgba(255,255,255,0.12)] hover:bg-[#1A1A1E]",
        className
      )}
      {...props}
    />
